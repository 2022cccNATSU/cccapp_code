...
String comments(int month,int day,int hour) {
  ...
  if (month == 1) {
      if (5<=hour&&hour<=9) {
        return ('眠い！寒い！布団から出たくない～！');
      } else if (hour==12) {
        return('きれいな雪．．．冬なのにかき氷食べたくなって来ちゃった');
      } else if (19<=hour&&hour<=20) {
        return ('こたつ～、心の友よ～');
      } else if (hour==21) {
        return ('げっ！！ストーブの灯油が切れた．．．');
      } else if (24<=hour||hour<=4) {
        return ('もう寝ようよ、明日に響いちゃうよ～');
      } else {
        if (day == 1) {
          ...
          return ('う～寒いなぁ、早くあったかくなんないかな～');
        }
      }
  } else if (month == 2) {
    if (5<=hour&&hour<=9) {
      return ('まだ寒いなぁ、1日中布団にくるまっていたい．．．');
    } else if (hour==12) {
      return('まだまだ冬だね～');
    } else if (19<=hour&&hour<=20) {
      return ('こたつよ、私にはまだまだ君の力が必要なようだ');
    } else if (hour==21) {
      return ('う～ん、寒いとついつい長風呂しちゃう．．．');
    } else if (24<=hour||hour<=4) {
      return ('もう寝ようよ、明日に響いちゃうよ～');
    } else {
      if (day == 1) {
        ...
        return ('暖かくなれ～、暖かくなれ～、ムムム．．．');
      }
    }
  } else if (month == 3) {
    if (5<=hour&&hour<=9) {
      return ('ちょっと暖かくなってきたかな？だがしかし布団からは逃れられない！');
    } else if (hour==12) {
      return('昼になるとけっこう暖かくなるね');
    } else if (19<=hour&&hour<=20) {
      return ('こたつとの別れの日も近い．．．');
    } else if (hour==21) {
      return ('ストーブお疲れ様、冬にまたよろしくね。');
    } else if (24<=hour||hour<=4) {
      return ('もう寝ようよ、明日に響いちゃうよ～');
    } else {
      if (day == 1) {
        ...
        return ('あともうちょっと暖かくなったら過ごしやすそう！');
      }
    }
  } else if (month == 4) {
    if (5<=hour&&hour<=9) {
      return ('あったかくて気持ちいい日が多くて助かるね♪、じゃあおやすみ');
    } else if (hour==12) {
      return('きれいな桜だね、すぐに散っちゃうから目に焼き付けとかないと。');
    } else if (19<=hour&&hour<=20) {
      return ('こたつよ、心の友よ．．．冬にまた会おう。');
    } else if (24<=hour||hour<=4) {
      return ('もう寝ようよ、明日に響いちゃうよ～');
    } else {
      if (day == 1) {
        ...
        return ('暖かくて過ごしやすいね、でもあの重い布団がちょっと恋しいな');
      }
    }
  } else if (month == 5) {
    if (5<=hour&&hour<=9) {
      return ('まだちょうどいい気温だね、2度寝したくなるほどに．．．');
    } else if (hour==12) {
      return('木々のみどりも鮮やかになってきたね');
    } else if (19<=hour&&hour<=20) {
      return ('そろそろ扇風機だそうかな');
    } else if (24<=hour||hour<=4) {
      return ('もう寝ようよ、明日に響いちゃうよ～');
      ...
      if (day == 1) {
        ...
        return ('ちょっと暑くなってきたね、でもまだ過ごしやすくていいね');
      }
    }
  } else if (month == 6) {
    if (5<=hour&&hour<=9) {
      return ('おはよう。ちょっと暑いね～、昼にはもっと暑くなりそう');
    } else if (hour==12) {
      return('もう梅雨だね～、雨は嫌いじゃないけど、こんなに多いと流石にね．．．');
    } else if (19<=hour&&hour<=20) {
      return ('扇風機、スイッチON！');
    } else if (24<=hour||hour<=4) {
      return ('もう寝ようよ、明日に響いちゃうよ～');
      ...
      if (day == 1) {
        ...
        return ('６月の花といえばアジサイだよね。近所にも咲いてるけどほんとにきれいだよね');
      }
    }
  } else if (month == 7) {
    if (5<=hour&&hour<=9) {
      return ('暑い～、そろそろクーラーつけようかな～');
    } else if (hour==12) {
      return('植物も空も色鮮やかで、いかにも夏って感じだね');
    } else if (19<=hour&&hour<=20) {
      return ('扇風機涼しい～、ワレワレハウチュウジンダ～');
    } else if (24<=hour||hour<=4) {
      return ('もう寝ようよ、明日に響いちゃうよ～');
    } else {
      if (day == 1) {
        ...
        return ('暑いね～、でもそのおかげでアイスがおいしい！');
      }
    }
  } else if (month == 8) {
    if (5<=hour&&hour<=9) {
      return ('クーラーのリモコン～、ポチっとな！おやすみ！');
    } else if (hour==12) {
      return('ホントにクーラーさまさまだね～');
    } else if (19<=hour&&hour<=20) {
      return ('クーラーと扇風機とアイスの完璧な布陣！');
    } else if (24<=hour||hour<=4) {
      return ('もう寝ようよ、夏休みだからって気持ちもわかるけど、明日に響いちゃうよ～');
    } else {
      if (day == 1) {
        ...
        return ('暑い～もう毎日プール行きたいよ～');
      }
    }
  }else if (month == 9) {
    if (5<=hour&&hour<=9) {
      return ('まだちょっと暑いかな。でも二度寝はしやすいね。おやすみ！');
    } else if (hour==12) {
      return('そろそろ秋の味覚を堪能できる時期に．．．');
    } else if (19<=hour&&hour<=20) {
      return ('そろそろ扇風機もしまい時かも。');
    } else if (24<=hour||hour<=4) {
      return ('もう寝ようよ、明日に響いちゃうよ～');
    } else {
      if (day == 1) {
        ...
        return ('暑さは段々落ち着いてきたかな。過ごしやすくなってきたね。');
      }
    }
  }else if (month == 10) {
    if (5<=hour&&hour<=9) {
      return ('涼しくなってきたね。二度寝、じゃなくて過ごしやすくていい感じ！');
    } else if (hour==12) {
      return('さっつまいも♪さっつまいも♪焼き芋に芋タルトにスイートポテト！');
    } else if (19<=hour&&hour<=20) {
      return ('さらば扇風機！私は君を忘れない！');
    } else if (24<=hour||hour<=4) {
      return ('もう寝ようよ、明日に響いちゃうよ～');
    } else {
      if (day == 1) {
        ...
        return ('今日はハロウィン！毎日妖精の仮装してるからお菓子一年分ちょうだい♪トリートオアトリート！');
      } else {
        return ('ちょっと暑くなってきたね、でもまだ過ごしやすくていいね');
      }
    }
    ...
    if (5<=hour&&hour<=9) {
      return ('ちょっと寒くなってきたね。でもまだイケる！');
    } else if (hour==12) {
      return('段々落ち葉も増えてきたね。集めて焼き芋したいなぁ。');
    } else if (19<=hour&&hour<=20) {
      return ('充電中のスマホがあったかい～');
    } else if (24<=hour||hour<=4) {
      return ('もう寝ようよ、明日に響いちゃうよ～');
    } else {
      if (day == 1) {
        ...
        return ('ちょっと寒いね。そろそろストーブが必要かな。');
      }
    }
  }else if (month == 12) {
    if (5<=hour&&hour<=9) {
      return ('結構寒いね～。朝はストーブが欲しいな～');
    } else if (hour==12) {
      return('寒いね～。そんな昼にはホットココア！');
    } else if (19<=hour&&hour<=20) {
      return ('ストーブセット！ファイアー！');
    } else if (24<=hour||hour<=4) {
      return ('もう寝ようよ、明日に響いちゃうよ～');
    } else {
      if (day == 1) {
